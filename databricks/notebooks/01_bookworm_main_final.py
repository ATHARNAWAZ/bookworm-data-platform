...
# Cell 4 — Bronze Ingestion (Books, Authors, Genres, Series)
#
...
# Cell 5 — Bronze Ingestion (Reviews)
#
...
silver_books = (
    ...
    .withColumn("rn", F.row_number().over(
            Window.partitionBy("book_id")
                .orderBy(F.col("ratings_count").cast("bigint").desc())
            ))
...
# Cell 8 — Register Tables in Unity Catalog
#
...
tables = {
    ...
    "bronze_genres"            : f"{BRONZE_PATH}genres/",
